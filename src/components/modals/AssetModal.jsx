...
export default function AssetModal({ data, s, T, setModal, updArr }) {
  ...
  const [f, setF] = useState(data || { name:"", owner:owners[0]?.id||"ehemann", class:"Aktien-ETF", liquidity:"Liquide", value:"", debt:"", locked:false, note:"", loanRate:"3.5", loanTilgung:"0", loanAnnuitat:"0" });
